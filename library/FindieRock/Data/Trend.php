	...
	{		
		...
		public static function SaveTrend($type, $targetId, $ip = null) {
			...
			try {
				...
				$log->info("Duplicate entry for trend: {$type}/{$targetId}/{$ip}");
			}
			return $saved;
		}
		
		public static function LoadTrend($type, $max = FindieRock_Constants::MAX_TREND, $days = FindieRock_Constants::ONE_WEEK)
		{
