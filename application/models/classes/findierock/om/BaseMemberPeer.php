...
abstract class BaseMemberPeer {
	...
	const CLASS_DEFAULT = 'findierock.Member';
	...
	/** the column name for the SCREENNAME field */
	const SCREENNAME = 'member.SCREENNAME';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Memberid', 'Screenname', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('memberid', 'screenname', ),
		BasePeer::TYPE_COLNAME => array (self::MEMBERID, self::SCREENNAME, ),
		BasePeer::TYPE_RAW_COLNAME => array ('MEMBERID', 'SCREENNAME', ),
		BasePeer::TYPE_FIELDNAME => array ('MemberId', 'ScreenName', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Memberid' => 0, 'Screenname' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('memberid' => 0, 'screenname' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::MEMBERID => 0, self::SCREENNAME => 1, ),
		BasePeer::TYPE_RAW_COLNAME => array ('MEMBERID' => 0, 'SCREENNAME' => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('MemberId' => 0, 'ScreenName' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(MemberPeer::MEMBERID);
			$criteria->addSelectColumn(MemberPeer::SCREENNAME);
		} else {
			$criteria->addSelectColumn($alias . '.MEMBERID');
			$criteria->addSelectColumn($alias . '.SCREENNAME');
		}
	}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = MemberPeer::getOMClass(false);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = MemberPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + MemberPeer::NUM_COLUMNS;
		} else {
	...
	{
		return $withPrefix ? MemberPeer::CLASS_DEFAULT : MemberPeer::OM_CLASS;
	}
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(MemberPeer::MEMBERID) && $criteria->keyContainsValue(MemberPeer::MEMBERID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.MemberPeer::MEMBERID.')');
		}
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(MemberPeer::MEMBERID);
			$value = $criteria->remove(MemberPeer::MEMBERID);
			if ($value) {
				$selectCriteria->add(MemberPeer::MEMBERID, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(MemberPeer::MEMBERID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(MemberPeer::MEMBERID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(MemberPeer::DATABASE_NAME);
			$criteria->add(MemberPeer::MEMBERID, $pks, Criteria::IN);
