...
abstract class BaseEventtypePeer {
	...
	const CLASS_DEFAULT = 'findierock.Eventtype';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Eventtypeid', 'Type', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('eventtypeid', 'type', ),
		BasePeer::TYPE_COLNAME => array (self::EVENTTYPEID, self::TYPE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('EVENTTYPEID', 'TYPE', ),
		BasePeer::TYPE_FIELDNAME => array ('EventTypeId', 'Type', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Eventtypeid' => 0, 'Type' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('eventtypeid' => 0, 'type' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::EVENTTYPEID => 0, self::TYPE => 1, ),
		BasePeer::TYPE_RAW_COLNAME => array ('EVENTTYPEID' => 0, 'TYPE' => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('EventTypeId' => 0, 'Type' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(EventtypePeer::EVENTTYPEID);
			$criteria->addSelectColumn(EventtypePeer::TYPE);
		} else {
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Eventtype) {
				$key = (string) $value->getEventtypeid();
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(EventtypePeer::EVENTTYPEID) && $criteria->keyContainsValue(EventtypePeer::EVENTTYPEID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.EventtypePeer::EVENTTYPEID.')');
		}
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(EventtypePeer::EVENTTYPEID);
			$value = $criteria->remove(EventtypePeer::EVENTTYPEID);
			if ($value) {
				$selectCriteria->add(EventtypePeer::EVENTTYPEID, $value, $comparison);
			} else {
	...
	/**
	 * Method to DELETE all rows from the eventtype table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(EventtypePeer::EVENTTYPEID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(EventtypePeer::EVENTTYPEID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(EventtypePeer::DATABASE_NAME);
			$criteria->add(EventtypePeer::EVENTTYPEID, $pks, Criteria::IN);
