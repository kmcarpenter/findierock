...
/**
 * Base class that represents a row from the 'findie_wp_users' table.
 *
 * 
 *
 * @package    propel.generator.findierock.om
 */
abstract class BaseFindieWpUsers extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
  const PEER = 'FindieWpUsersPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        FindieWpUsersPeer
	 */
	...
	/**
	 * Initializes internal state of BaseFindieWpUsers object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     FindieWpUsers The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = FindieWpUsersPeer::ID;
		}
	...
	public function setUserLogin($v)
	{
		...
		if ($this->user_login !== $v || $this->isNew()) {
			$this->user_login = $v;
			$this->modifiedColumns[] = FindieWpUsersPeer::USER_LOGIN;
		}
	...
	public function setUserPass($v)
	{
		...
		if ($this->user_pass !== $v || $this->isNew()) {
			$this->user_pass = $v;
			$this->modifiedColumns[] = FindieWpUsersPeer::USER_PASS;
		}
	...
	public function setUserNicename($v)
	{
		...
		if ($this->user_nicename !== $v || $this->isNew()) {
			$this->user_nicename = $v;
			$this->modifiedColumns[] = FindieWpUsersPeer::USER_NICENAME;
		}
	...
	public function setUserEmail($v)
	{
		...
		if ($this->user_email !== $v || $this->isNew()) {
			$this->user_email = $v;
			$this->modifiedColumns[] = FindieWpUsersPeer::USER_EMAIL;
		}
	...
	public function setUserUrl($v)
	{
		...
		if ($this->user_url !== $v || $this->isNew()) {
			$this->user_url = $v;
			$this->modifiedColumns[] = FindieWpUsersPeer::USER_URL;
		}
	...
	public function setUserRegistered($v)
	{
		...
		if ( $this->user_registered !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = FindieWpUsersPeer::USER_REGISTERED;
			}
	...
	public function setUserActivationKey($v)
	{
		...
		if ($this->user_activation_key !== $v || $this->isNew()) {
			$this->user_activation_key = $v;
			$this->modifiedColumns[] = FindieWpUsersPeer::USER_ACTIVATION_KEY;
		}
	...
	public function setUserStatus($v)
	{
		...
		if ($this->user_status !== $v || $this->isNew()) {
			$this->user_status = $v;
			$this->modifiedColumns[] = FindieWpUsersPeer::USER_STATUS;
		}
	...
	public function setDisplayName($v)
	{
		...
		if ($this->display_name !== $v || $this->isNew()) {
			$this->display_name = $v;
			$this->modifiedColumns[] = FindieWpUsersPeer::DISPLAY_NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 10; // 10 = FindieWpUsersPeer::NUM_COLUMNS - FindieWpUsersPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating FindieWpUsers object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = FindieWpUsersPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				FindieWpUsersPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(FindieWpUsersPeer::ID) ) {
					...
					$affectedRows = FindieWpUsersPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = FindieWpUsersPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = FindieWpUsersPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = FindieWpUsersPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FindieWpUsersPeer::ID)) $criteria->add(FindieWpUsersPeer::ID, $this->id);
		if ($this->isColumnModified(FindieWpUsersPeer::USER_LOGIN)) $criteria->add(FindieWpUsersPeer::USER_LOGIN, $this->user_login);
		if ($this->isColumnModified(FindieWpUsersPeer::USER_PASS)) $criteria->add(FindieWpUsersPeer::USER_PASS, $this->user_pass);
		if ($this->isColumnModified(FindieWpUsersPeer::USER_NICENAME)) $criteria->add(FindieWpUsersPeer::USER_NICENAME, $this->user_nicename);
		if ($this->isColumnModified(FindieWpUsersPeer::USER_EMAIL)) $criteria->add(FindieWpUsersPeer::USER_EMAIL, $this->user_email);
		if ($this->isColumnModified(FindieWpUsersPeer::USER_URL)) $criteria->add(FindieWpUsersPeer::USER_URL, $this->user_url);
		if ($this->isColumnModified(FindieWpUsersPeer::USER_REGISTERED)) $criteria->add(FindieWpUsersPeer::USER_REGISTERED, $this->user_registered);
		if ($this->isColumnModified(FindieWpUsersPeer::USER_ACTIVATION_KEY)) $criteria->add(FindieWpUsersPeer::USER_ACTIVATION_KEY, $this->user_activation_key);
		if ($this->isColumnModified(FindieWpUsersPeer::USER_STATUS)) $criteria->add(FindieWpUsersPeer::USER_STATUS, $this->user_status);
		if ($this->isColumnModified(FindieWpUsersPeer::DISPLAY_NAME)) $criteria->add(FindieWpUsersPeer::DISPLAY_NAME, $this->display_name);
	...
	{
		$criteria = new Criteria(FindieWpUsersPeer::DATABASE_NAME);
		$criteria->add(FindieWpUsersPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of FindieWpUsers (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     FindieWpUsers Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     FindieWpUsersPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new FindieWpUsersPeer();
		}
		return self::$peer;
	}
	 ...
	 * If this FindieWpUsers is new, it will return
	 ...
	 * Otherwise if this FindieWpUsers is new, it will return
	 * an empty collection; or if this FindieWpUsers has previously
	 * been saved, it will retrieve related UserLinkWps from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in FindieWpUsers.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array UserLinkWp[] List of UserLinkWp objects
	 */
	public function getUserLinkWpsJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = UserLinkWpQuery::create(null, $criteria);
