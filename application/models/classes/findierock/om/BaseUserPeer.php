...
abstract class BaseUserPeer {
	...
	const CLASS_DEFAULT = 'findierock.User';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Userid', 'Username', 'Password', 'Email', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userid', 'username', 'password', 'email', ),
		BasePeer::TYPE_COLNAME => array (self::USERID, self::USERNAME, self::PASSWORD, self::EMAIL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('USERID', 'USERNAME', 'PASSWORD', 'EMAIL', ),
		BasePeer::TYPE_FIELDNAME => array ('userid', 'username', 'password', 'email', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Userid' => 0, 'Username' => 1, 'Password' => 2, 'Email' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userid' => 0, 'username' => 1, 'password' => 2, 'email' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::USERID => 0, self::USERNAME => 1, self::PASSWORD => 2, self::EMAIL => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('USERID' => 0, 'USERNAME' => 1, 'PASSWORD' => 2, 'EMAIL' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('userid' => 0, 'username' => 1, 'password' => 2, 'email' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
