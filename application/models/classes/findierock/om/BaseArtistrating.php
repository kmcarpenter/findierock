...
/**
 * Base class that represents a row from the 'artistrating' table.
 *
 * 
 *
 * @package    propel.generator.findierock.om
 */
abstract class BaseArtistrating extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
  const PEER = 'ArtistratingPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ArtistratingPeer
	 */
	 ...
	 * @return     Artistrating The current object (for fluent API support)
	 */
	public function setArtistid($v)
	{
		...
		if ($this->artistid !== $v) {
			$this->artistid = $v;
			$this->modifiedColumns[] = ArtistratingPeer::ARTISTID;
		}
	...
	public function setUserid($v)
	{
		...
		if ($this->userid !== $v) {
			$this->userid = $v;
			$this->modifiedColumns[] = ArtistratingPeer::USERID;
		}
	...
	public function setRating($v)
	{
		...
		if ($this->rating !== $v) {
			$this->rating = $v;
			$this->modifiedColumns[] = ArtistratingPeer::RATING;
		}
	...
	public function setComments($v)
	{
		...
		if ($this->comments !== $v) {
			$this->comments = $v;
			$this->modifiedColumns[] = ArtistratingPeer::COMMENTS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = ArtistratingPeer::NUM_COLUMNS - ArtistratingPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Artistrating object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArtistratingPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ArtistratingPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += ArtistratingPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArtistratingPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArtistratingPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArtistratingPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArtistratingPeer::ARTISTID)) $criteria->add(ArtistratingPeer::ARTISTID, $this->artistid);
		if ($this->isColumnModified(ArtistratingPeer::USERID)) $criteria->add(ArtistratingPeer::USERID, $this->userid);
		if ($this->isColumnModified(ArtistratingPeer::RATING)) $criteria->add(ArtistratingPeer::RATING, $this->rating);
		if ($this->isColumnModified(ArtistratingPeer::COMMENTS)) $criteria->add(ArtistratingPeer::COMMENTS, $this->comments);
	...
	{
		$criteria = new Criteria(ArtistratingPeer::DATABASE_NAME);
		$criteria->add(ArtistratingPeer::ARTISTID, $this->artistid);
		$criteria->add(ArtistratingPeer::USERID, $this->userid);
	...
	{
		return (null === $this->getArtistid()) && (null === $this->getUserid());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Artistrating (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Artistrating Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ArtistratingPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArtistratingPeer();
		}
		return self::$peer;
	}
	...
	public function getArtist(PropelPDO $con = null)
	{
		if ($this->aArtist === null && ($this->artistid !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aArtist->addArtistratings($this);
			 */
		}
		return $this->aArtist;
	}
	...
	public function getUser(PropelPDO $con = null)
	{
		if ($this->aUser === null && ($this->userid !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUser->addArtistratings($this);
			 */
		}
		return $this->aUser;
	}
