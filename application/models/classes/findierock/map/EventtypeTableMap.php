...
class EventtypeTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'findierock.map.EventtypeTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		// columns
		$this->addPrimaryKey('EVENTTYPEID', 'Eventtypeid', 'INTEGER', true, 11, null);
	...
	{
    $this->addRelation('Event', 'Event', RelationMap::ONE_TO_MANY, array('EventTypeId' => 'EventTypeId', ), 'RESTRICT', 'RESTRICT');
	} // buildRelations()
