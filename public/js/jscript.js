jQuery(function(){
  ...
  jQuery(".dropdown_search").toggle(function(){
   jQuery(this).addClass("active_dropdown_tag"); 
    }, function () {
   jQuery(this).removeClass("active_dropdown_tag");
    });
  jQuery(".dropdown_search").click(function(){
    jQuery(this).next("#city_search").slideToggle("400");
   });
